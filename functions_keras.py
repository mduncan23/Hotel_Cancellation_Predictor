...
def cv_score(model, 
    ...
    if abs(cv_results_dict['Train Accuracy'][0] - cv_results_dict['Test Accuracy'][0]) > .05 or\
       abs(cv_results_dict['Train Precision'][0] - cv_results_dict['Test Precision'][0]) > .05 or\
       abs(cv_results_dict['Train Recall'][0] - cv_results_dict['Test Recall'][0]) > .05 or\
       abs(cv_results_dict['Train F1 Score'][0] - cv_results_dict['Test F1 Score'][0]) > .05 or\
       abs(cv_results_dict['Train ROC/AUC Score'][0] - cv_results_dict['Test ROC/AUC Score'][0]) > .05:
